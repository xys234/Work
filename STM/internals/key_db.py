...
NETWORK_KEYS = {
    ...
    'NEW_TRAJECTORY_FILE': KeyInfo(KeyValueTypes.FILE, '', Offset.NETWORK_KEYS_OFFSET + 14, KeyGroupTypes.SINGLE, Help.FILE_HELP),
    'NEW_TRAJECTORY_FORMAT': KeyInfo(KeyValueTypes.STRING, 'BINARY', Offset.NETWORK_KEYS_OFFSET + 15, KeyGroupTypes.SINGLE, Help.NO_HELP),
}
